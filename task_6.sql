...
insert into bl_3nf.ce_countries (country_id,country_name,country_src_id,inset_dt,update_dt,source_system,source_entity)
		select -1,
			   'n,a',
			   'n,a',
			   '1-1-1900'::date,
